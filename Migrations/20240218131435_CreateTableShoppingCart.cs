        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<string>(type: "nvarchar(450)", nullable: false).Annotation("SqlServer:Identity", true)
        },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCart_Table_TableId",
                        column: x => x.TableId,
